...
export default function Login() {
    ...
    return (
        <div className="relative bg-black h-screen flex items-center justify-center overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center max-w-6xl w-full shadow-lg bg-gradient-to-r from-white via-slate-200 to-slate-300  overflow-hidden z-10">
                {/* Left Side - Image */}
                <div className="hidden lg:block w-1/2 h-full">
                    <img src={fg} alt="Login Illustration" className="w-full h-[450px] object-cover" />
                </div>
