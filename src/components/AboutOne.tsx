...
const AboutPage = () => {
  ...
  <Link to="/book-consultation">
    <motion.a
      className="px-8 py-3 hover:shadow-2xl sm:mt-6 text-sm font-bold text-white bg-gradient-to-r from-gray-400 via-gray-600 to-blue-800 rounded-full transition-all duration-300"
      href="#"
