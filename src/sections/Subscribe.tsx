...
export const Subscribe = () => {
  ...
  return (
    <motion.div 
      ...
      className="font-[sans-serif] px-6 py-16 bg-gradient-to-t from-gray-300 via-gray-50 to-gray-50"
    >
      <div className="text-center max-w-3xl max-md:max-w-md mx-auto">
        ...
        >
          <p className="text-base text-gray-500 leading-relaxed">
            Join our community of forward-thinking professionals. Get exclusive insights,
            industry updates, and strategic guidance delivered directly to your inbox.
          </p>
        </motion.div>
