...
import { gifappz, gifa } from "../assets/images";
                        ...
                        <div className="flex items-center justify-end space-x-4">
                            ...
                            >
                                ...
                                <svg width="24" height="24" viewBox="0 0 27 27" fill="none">
                                    <path d="M10.7051 7.12817L4.15732 13.6759L10.7051 20.2237" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
                                    <path d="M22.4941 13.6759H4.33949" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
                                </svg>
                            </motion.button>
                            <motion.button
                                whileHover={{ scale: 1.05 }}
                            ...
                            >
                                {/* Right Arrow */}
                                <svg width="24" height="24" viewBox="0 0 27 27" fill="none">
                                    <path d="M16.2949 7.12817L22.8427 13.6759L16.2949 20.2237" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
                                    <path d="M4.50586 13.6759H22.6605" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
                                </svg>
                            </motion.button>
                        </div>
                    </div>
